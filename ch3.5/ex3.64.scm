;;;Exercise 3.64.  Write a procedure stream-limit that takes as arguments a stream and a number (the tolerance). 
...
(define (steam-limit s tolerance)
    (if (< (- (stream-ref s 1) (stream-ref s 0)) tolerance)
      (stream-ref s 1)
